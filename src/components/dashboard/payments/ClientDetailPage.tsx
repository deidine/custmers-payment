        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <span className="text-blue-100 text-sm">
              Membre depuis {client.membershipStartDate ? formatDate(client.membershipStartDate) : formatDate(client.createdAt)}
            </span>
            </div>
          </div>
      ...
      {activeTab === "overview" && (
       ...
       <div className="bg-blue-50 rounded-lg p-6">
          ...
          <div className="bg-green-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-green-900 mb-4">Résumé des paiements</h3>
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium text-green-700">Paiements totaux</label>
                <p className="mt-1 text-2xl font-bold text-green-900">{formatCurrency(calculateTotalPayments())}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-green-700">Nombre de paiements</label>
