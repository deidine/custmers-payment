...
export default function SubscriptionPdfPage() {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      if (result) {
        ...
        setError("Impossible de générer le PDF. Vérifiez l'ID client.")
      }
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 sm:p-8 lg:p-10 flex flex-col items-center">
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-8">Générer le PDF de Souscription</h1>
